...
{
    public class CancelBidService
    {
        public event EventHandler<BidEventArgs> CancelBid;

        public void CancelBidLocally(Guid listingId, Bid bid)
        {
        ...
        private void ReceivedCancelBid(Guid listingId, Guid bidId, int originalBidder)
        {
            var listing = Utilities.GameManager.Instance.ListingRepository.GetListing(listingId);
