...
{
    public class PersonalListingDisplay : MonoBehaviour, IListingDisplay
    {
        ...
        // Add bids to display
        public void Init(Listing listing, Dictionary<ListingDisplayAction, Action> displayActions)
        {
            ...
            select.onClick.AddListener(displayActions[ListingDisplayAction.Select].Invoke);
        }
