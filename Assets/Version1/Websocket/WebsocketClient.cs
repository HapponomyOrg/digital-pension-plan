            ...
            try
            {
                switch (subject)
                {
                    ...
                    case MessageSubject.MakeBidding:
                        OnMakeBidding?.Invoke(this, JsonUtility.FromJson<MakeBiddingMessage>(jsonData));
                        break;
                    case MessageSubject.AcceptBidding:
                        OnAcceptBidding?.Invoke(this, JsonUtility.FromJson<AcceptBiddingMessage>(jsonData));
                        break;
                    case MessageSubject.CancelBidding:
                        OnCancelBidding?.Invoke(this, JsonUtility.FromJson<CancelBiddingMessage>(jsonData));
                        break;
                    case MessageSubject.RejectBidding:
                        OnRejectBidding?.Invoke(this, JsonUtility.FromJson<RejectBiddingMessage>(jsonData));
                        break;
                    case MessageSubject.RespondBidding:
                        OnRespondBidding?.Invoke(this, JsonUtility.FromJson<RespondBiddingMessage>(jsonData));
                        break;
